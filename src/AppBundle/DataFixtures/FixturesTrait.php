...
[Integer auctor massa maximus](https://sargantanacode.es) nulla scelerisque
accumsan. *Aliquam ac malesuada* ex.
Pellentesque tortor magna, vulputate eu vulputate ut, venenatis ac lectus.
...
MARKDOWN;
    ...
    private function getRandomPostExcerpt($maxLength = 255)
    {
        $phrases = $this->getPhrases();
